...
def takeCommand(): 
    ...
    with sr.Microphone() as source: 
        ...
        try: 
            ...
            list_speak = ['hmmm I am trying to recognize give me a sec', 'that was confusing, let me try to figure out', 'you have a great voice nice to hear you'] 
            speak(random.choice(list_speak)) 
            Query = r.recognize_google(audio, language='en-in') 
            print("command is:", Query) 
        except Exception as e: 
            print(e) 
            speak("Sorry couldn't recognize what you are saying") 
            print("Sorry couldn't recognize what you are saying") 
            return "None" 
        return Query 
...
if __name__ == '__main__': 
    ...
    photo = PhotoImage(file = "C:/Users/Pranathi/Documents/Python Scripts/gui 3.png") 
